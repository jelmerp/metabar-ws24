...
subtitle: "Loading 'modules' and activating _Conda_ environments,<br> with extra reading on installation with _Conda_ and using _Apptainer_ containers"
pagetitle: "Software"
...
At supercomputers like OSC,
there are often system-wide installations of a number of bioinformatics programs.
...
## Bonus I: Creating your own _Conda_ environments {-}
...
cat img/trimgalore_install.txt
```
...
## Bonus II: Using _Apptainer_ containers {-}
